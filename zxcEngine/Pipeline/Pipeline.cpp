...
namespace zxc {
	...
	PipelineConfigInfo Pipeline::CreateDefaultConfigInfo(uint32_t width, uint32_t height)
	{
	...
	void Pipeline::CreateShaderModule(const vector<char>& data, VkShaderModule* shaderModule)
	{
